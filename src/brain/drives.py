...
class MotivationalDrives:
    ...
    def compute_drive_strengths(self, state: dict) -> DriveState:
        ...
        self.state.exploration = (
            ...
            (1 - self.DECAY) * np.clip(self.BASELINES['exploration'] + boredom, 0, 1)
        )
        ...
        # smell_strength is a proxy for visual salience of nearby objects.
        smell_strength = state.get('smell_strength', 0.0)
        play_signal = smell_strength * 0.6  # Object salience drives play
        if is_fallen:
